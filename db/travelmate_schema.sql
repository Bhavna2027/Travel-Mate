...
-- Derived from PRD v2.0 + TRD v2.0, with corrections noted inline
-- ============================================================
...
CREATE TABLE users (
    ...
    password_hash VARCHAR(255) NOT NULL, -- Added to support secure authentication specified in TRD
    ...
    deleted_at TIMESTAMPTZ,                     -- soft delete for DPDP/GDPR deletion requests
...
-- ============================================================
-- DESTINATIONS / ITINERARY TEMPLATES
-- ============================================================
...
CREATE TABLE bookings (
    ...
    guide_request_id UUID REFERENCES guide_requests(request_id) ON DELETE SET NULL,
