...
export async function updateProfile(req: AuthenticatedRequest, res: Response) {
  try {
    ...
    const {
      name, age, gender, gender_preference, travel_styles, languages, device_info,
      bio, profile_picture_url, interests, travel_experience, preferred_accommodation,
      emergency_contacts
    } = req.body;
    ...
    const updatedUser = await prisma.$transaction(async (tx) => {
      ...
      if (gender_preference !== undefined) userUpdateData.gender_preference = gender_preference;
      if (travel_styles !== undefined) userUpdateData.travel_styles = travel_styles;
      if (languages !== undefined) userUpdateData.languages = languages;
      if (device_info !== undefined) userUpdateData.device_info = device_info;
      ...
      if (profile_picture_url !== undefined) profileUpdateData.profile_picture_url = profile_picture_url;
      if (interests !== undefined) profileUpdateData.interests = interests;
      if (travel_experience !== undefined) profileUpdateData.travel_experience = travel_experience;
      if (preferred_accommodation !== undefined) profileUpdateData.preferred_accommodation = preferred_accommodation;
